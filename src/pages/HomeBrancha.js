...
import { faAngleDown, faClose, faDollar, faFileAlt, faPlus, faScaleBalanced, faUser, faUserPlus   } from '@fortawesome/free-solid-svg-icons';
    ...
    return (
        <section className='home-branch'>
            ...
            <div className='middle'>
                ...
                <div className='money'>
                    <h4>TZS-TZS</h4>
                    {/* <MdKeyboardArrowDown className="left"/> */}
            ...
            <div className='statistics'>
                ...
                <div className='total year'>
                    <div className='up'>
                        <div className='left'>
                            <div className='num'>
                                <h3>67,200,000.00 - Total</h3>
                            </div>
                            <div className='num'>
                                <h3>8,500,000.00 - This year</h3>
                            </div>
                            <div className='num'>
                                <h3>400,000.00 - This month</h3>
                            </div>
                        </div>
